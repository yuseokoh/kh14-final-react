...
import "./PaymentCancellationPage.css";
...
const PaymentCancellationPage = () => {
  ...
  if (result === null) {
    return <h1>결제 취소 진행 중입니다...</h1>;
  } else if (result === true) {
    return (
      <div className="payment-cancel-success-container container text-center py-5">
